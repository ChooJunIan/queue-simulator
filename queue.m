function queue
   ...
   while (center == 1)
    ...
    %fprintf('The average waiting time : %2.0f', avg_wait);
    %fprintf('The average time spent     : %2.0f', [avg_spent]);
    %fprintf('The average service time 1 : %2.0f', [avg_serveA]);
    %fprintf('The average service time 2 : %2.0f', [avg_serveB]);
    %fprintf('The probability of a customer has to wait : %2.0f', [prob_wait]);
